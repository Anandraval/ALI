...
const MobileMinter = (props) => {
  return (
    <div className="MobileMinter">
      ...
      <a className="nav-item" href="#AngelMap">
        ANGELMAP
      </a>
      ...
      <a className="nav-item" href="#MAS 2.0">
        MAS 2.0
      </a>
      ...
      <h3>
      Marvellous Angels is a collection of 20,000 randomly-generated NFTs 
      ...
      <br />
      <hr className="Divider" id="AngelMap" />
      <br />
      ...
      <br />
      <hr className="Divider" id="MAS 2.0" />
      <br />
